                        ...
                        <div class="col">
                            <div class="card card-outline card-danger">
                                <div class="card-header">
                                    <h3 class="card-title"><a href="<?= base_url('master/add_atribut') ?>" class="btn btn-sm btn-block bg-gradient-danger"><i class="fas fa-plus"></i> Tambah Data</a></h3>
                                </div>
                                <!-- /.card-header -->
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                <li><a class="dropdown-item" href="<?= base_url('master/edit_atribut/' . $atribut['id_atribut']) ?>"><i class="fas fa-edit"></i> Edit</a></li>
                                                                <li><a class="dropdown-item tombol-hapus" href="<?= base_url('master/delete_atribut/' . $atribut['id_atribut']) ?>"><i class="far fa-trash-alt"></i> Delete</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
